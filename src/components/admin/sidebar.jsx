...
<aside class=" w-64 h-screen " aria-label="Sidebar">
   <div class="h-screen w-full py-12 overflow-y-auto rounded bg-gray-50 dark:bg-gray-900">
      <div >
      <ul class="space-y-2 ">
         <li>
         ...
         <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Hotels</span>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <Link to='/AddHotel'>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View Hotel</a>
                     </Link>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Hotel</a>
                  </li>
                  <li>
