...
<section className="text-gray-700 body-font overflow-hidden bg-white">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <img alt="ecommerce" data-bs-toggle="modal" data-bs-target="#exampleModalCenteredScrollable" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={hotel.imageUrls}/>
