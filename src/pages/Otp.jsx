...
// console.log(data.formData.name,"name")
...
<h5 class="text-xl  font-medium text-gray-900 text-center  dark:text-white">Enter the OTP Here</h5>
<div>
  
    {/* <label for="email"  class="block  mb-6 text-sm font-medium text-gray-900 dark:text-white">Email</label> */}
    <input type="type" name="otp" id="otp" onChange={handleOtp}   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Plese Enter The Otp You recieved" required />
</div>
