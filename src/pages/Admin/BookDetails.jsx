  ...
  return (
    <>
      <div className="mt-10 flex justify-center ">
                <img class="object-cover mr-5 rounded-md" src={room.roomId?.images[0]} style={{width:"200px", height:"200px"}} />
              </div>
              ...
              <div class="flex justify-center p-4 leading-normal">
                ...
                <p class="mb-2 text-2xl text-center font-normal tracking-tight ml-2">
                  ...
                  Room ID:{room?.roomId?._id}<br/>
                  Hotel:{room.hotelName}<br/>
                  Booked Person:{room?.name},<br />
                  Number Of Guests:{room.adults}<br/>
                  ...
                  Bed:{room?.roomId?.bed}<br/>
                  AC:{room?.roomId?.AC}<br/>
                  Laundry :{room?.roomId?.laundry},<br />
                  WIFI:{room?.roomId?.wifi}<br/>
                </p>
